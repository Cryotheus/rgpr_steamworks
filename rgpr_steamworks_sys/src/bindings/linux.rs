...
const _: () = {
    [
        "Size of SetPersonaNameResponse_t",
    ][::std::mem::size_of::<SetPersonaNameResponse_t>() - 8usize];
    [
        "Alignment of SetPersonaNameResponse_t",
    ][::std::mem::align_of::<SetPersonaNameResponse_t>() - 4usize];
    [
        "Offset of field: SetPersonaNameResponse_t::m_bSuccess",
    ][::std::mem::offset_of!(SetPersonaNameResponse_t, m_bSuccess) - 0usize];
    [
        "Offset of field: SetPersonaNameResponse_t::m_bLocalSuccess",
    ][::std::mem::offset_of!(SetPersonaNameResponse_t, m_bLocalSuccess) - 1usize];
    [
        "Offset of field: SetPersonaNameResponse_t::m_result",
    ][::std::mem::offset_of!(SetPersonaNameResponse_t, m_result) - 4usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    [
        "Size of PSNGameBootInviteResult_t",
    ][::std::mem::size_of::<PSNGameBootInviteResult_t>() - 9usize];
    [
        "Alignment of PSNGameBootInviteResult_t",
    ][::std::mem::align_of::<PSNGameBootInviteResult_t>() - 1usize];
    [
        "Offset of field: PSNGameBootInviteResult_t::m_bGameBootInviteExists",
    ][::std::mem::offset_of!(PSNGameBootInviteResult_t, m_bGameBootInviteExists)
        - 0usize];
    [
        "Offset of field: PSNGameBootInviteResult_t::m_steamIDLobby",
    ][::std::mem::offset_of!(PSNGameBootInviteResult_t, m_steamIDLobby) - 1usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    [
        "Size of PS3TrophiesInstalled_t",
    ][::std::mem::size_of::<PS3TrophiesInstalled_t>() - 20usize];
    [
        "Alignment of PS3TrophiesInstalled_t",
    ][::std::mem::align_of::<PS3TrophiesInstalled_t>() - 4usize];
    [
        "Offset of field: PS3TrophiesInstalled_t::m_nGameID",
    ][::std::mem::offset_of!(PS3TrophiesInstalled_t, m_nGameID) - 0usize];
    [
        "Offset of field: PS3TrophiesInstalled_t::m_eResult",
    ][::std::mem::offset_of!(PS3TrophiesInstalled_t, m_eResult) - 8usize];
    [
        "Offset of field: PS3TrophiesInstalled_t::m_ulRequiredDiskSpace",
    ][::std::mem::offset_of!(PS3TrophiesInstalled_t, m_ulRequiredDiskSpace) - 12usize];
};
#[repr(C, packed(4))]
#[derive(Debug, Copy, Clone)]
...
unsafe extern "C" {
    pub fn SteamAPI_ISteamFriends_GetUserRestrictions(
        self_: *mut ISteamFriends,
    ) -> uint32;
}
unsafe extern "C" {
